...
// (Try to figure out what it takes to run on your own!)

// Then, with a partner, spend a few moments 
...
// Capture all the words in the address 
// (again ignoring the first two Node arguments)
...
// we are going to check the property names from google maps
// we want the value.. not the property name
// we use the property name to get the value
...
// callback within a callback because you need the location
// before you try to get the weather
